...
const tableColumns = [
    ...
    { name: '期初余额', key: 'Portfolioid', isInput: true, isDate: true, isRequired: true },
    { name: '期末余额', key: 'Portfolioid', isInput: true, isDate: true, isRequired: true },
